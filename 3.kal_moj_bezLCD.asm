...
COM:         EQU 01ABh ; wyśw. zawartosc rej. C, podac PWYS
CI:          EQU 0FFC6h; czekanie na puszczenie klawisza a potem na wcisniecie
CIM:         EQU 184H ; jak CSTS
hilo:        EQU 023bh

CYF0:        EQU 0FFF7h ;wyśw. cyfry na pozycji 0 wyświetlacza CA80
CYF1:        EQU 0FFF8h ;wyśw. cyfry na pozycji 1
CYF2:        EQU 0FFF9h
CYF3:        EQU 0FFFAh
CYF4:        EQU 0FFFBh
CYF5:        EQU 0FFFCh
...
kas_bufor:   EQU 0E2Ch ; kas. bufora  do obliczeń (podprogr.z kalkulatora)
wpis_buf:    EQU 0C57h ; wpis liczby do bufora
wys_buf:     EQU 0D41h ; wyświetla bufor, podprogram z kalkulatora CA88, do zam_16_na_10
...
PRZES: ; przesuwa tekst na wyświetlaczu ca80, jesli wcis. jakis klawisz to wyjscie z procedury
  LD C, (HL)
  CALL COM ; wyświetla rej. C
   defb 80h; to jest parametr PWYś 80
  LD B, 1H ; wartość opóźnienia
...
opoz_szuk:
 ...
 opoz_szuk1:
  call 1A0Eh; opóźnienie ok. 0,4 s
...
przelicz:
  ld bc, 0d8F0h ; (-10.000), uzupełnienie do 2 liczby 10.000
  call zamien_16
  ld bc, 0FC18h ; (-1.000, uzupeł. do 2 liczby 1.000
  call zamien_16
  ld bc, 0FF9ch ; (-100)
  call zamien_16
  ld bc, 0FFF6h ; (-10)
